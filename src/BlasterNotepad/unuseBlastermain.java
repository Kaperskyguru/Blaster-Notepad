...
//
//public class unuseBlastermain extends JFrame implements ActionListener {
//
...
//        west.setPreferredSize(new Dimension(150, 479));
...
//
//        final LineNumberingTextArea lineNumberingTextArea = new LineNumberingTextArea(new JTextArea());
...
//            }
//            title.setText(file.getAbsolutePath() + " - Kpashpad");
//        } catch (IOException e) {
...
//                    title.setText(jFileChooser1.getSelectedFile().getAbsolutePath() + " - Kpanshpad");
...
//            autoComplete(file1);
//
//            title.setText(file1.getAbsolutePath() + " - Kpashpad");
//        } catch (Exception e) {
